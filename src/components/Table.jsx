...
import { addAssets, addAssetsIcons } from "../store/actions";
...
export default function EnhancedTable() {
  ...
  React.useEffect(() => {
    axios
      .get("https://rest.coinapi.io/v1/assets/icons/32", {
        headers: { "X-CoinAPI-Key": "8E97AAFA-537C-4D28-990E-564BE55E8FA0" },
      })
      .then((res) => {
        dispatch(addAssetsIcons(res.data));
        console.log("RES ICONS", res.data);
      });
  }, []);
